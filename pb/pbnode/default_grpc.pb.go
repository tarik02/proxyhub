...
const (
	Service_MOTD_FullMethodName       = "/pb.pbnode.Service/MOTD"
	Service_Disconnect_FullMethodName = "/pb.pbnode.Service/Disconnect"
)
...
func (c *serviceClient) MOTD(ctx context.Context, in *MOTDRequest, opts ...grpc.CallOption) (*MOTDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MOTDResponse)
	err := c.cc.Invoke(ctx, Service_MOTD_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) MOTD(context.Context, *MOTDRequest) (*MOTDResponse, error) {
...
func _Service_MOTD_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MOTDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).MOTD(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_MOTD_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).MOTD(ctx, req.(*MOTDRequest))
	}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.pbnode.Service",
	HandlerType: (*ServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "MOTD",
			Handler:    _Service_MOTD_Handler,
		},
		{
	...
	Metadata: "pb/pbnode/default.proto",
}
